...
#' @note The metadata is in the first line of the CSV file.  It is preformated as an R expression. Therefore, 
...
#' summary(l)
#' }
#' @seealso \code{\link{ubitMetaData}} to get only metadata from a CSV-like result file and \code{\link{ubitData}} to get only data from a CSV-like result file as a matrix. 
#' @export
...
#' attributes(l)
#' }
#' @seealso \code{\link{ubitMetaData}} to get only metadata from a CSV-like result file.
#' @seealso \code{\link{ubitData}} to get only data from a CSV-like result file as a matrix.
#' @seealso \code{\link{ubitLoadFile}} to read a result file into a list of areas (more convenient).
#' @export
