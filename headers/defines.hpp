...
#define N_FEATURES 7
#define FEATURE_CLASSIF_ACCU_WEIGHT 0.1

//#define FEATURE_AREA_IDX 0
#define FEATURE_DIST_FROM_FORMER_IDX 0
#define FEATURE_BMEAN_IDX 1
#define FEATURE_BSD_IDX 2
#define FEATURE_GMEAN_IDX 3
#define FEATURE_GSD_IDX 4
#define FEATURE_RMEAN_IDX 5
#define FEATURE_RSD_IDX 6
