...
//The default option leaves the experimental arena undemarcated. \n  'Autocircles' allows you to generate a mask\
...
//pre-existing masks can be selected from file using the 'From file' option.\n\
...
//>>>>>>> 5a29937afd05214210ebeb44ec7c8b60e244c296
...
#define PAGE_OUTPUT_DESCRIPTION "Choose where to save the results of the analysis. \n\
\n\
Data is outputted in a .csv format, and can be readily interpreted using an \n\
available R package."
//>>>>>>> 5a29937afd05214210ebeb44ec7c8b60e244c296
