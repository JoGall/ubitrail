...
#define TOOLTIP_AREA_AUTOCIRCLE_LINES "Specifies the number of territories composing each area \n\
(default = 1 ; i.e. one territory per area)."


#define TOOLTIP_PROCPARS_SENSITIVITY "Determines how likely noise is to be detected as motion. \n\
Accepts values from 0 to 255, but is usually most effective between \n\
the range 2-10.  Low values may erroneously detect motion in \n\
